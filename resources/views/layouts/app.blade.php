           ...
           @else
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="{{ url('/aperturaCarreras') }}">Apertura de carrera</a>
                  <a class="dropdown-item" href="{{ url('/consultaCarrera') }}">Consulta de la carrera</a>
                  <a class="dropdown-item" href="{{ url('/listarCarrera') }}">Listade de Carreras</a>
                  <a class="dropdown-item" href="">Inscripción de la carrera</a>
                  <a class="dropdown-item" href="{{ url('/resultadosCarreras') }}">Registrar resultados</a>
                </div>
              </li>
