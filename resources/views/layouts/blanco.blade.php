      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
          ...
          <a class="navbar-brand" href="/">
            <img src="img/logotipo.png" style=" bottom:12px; display: inline-block; vertical-align: middle; width: 80px;">
          </a>
           ...
           @else
              <li class="nav-item">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  ...
                  <a class="dropdown-item" href="consultaCarrera">Inscripción de la carrera</a>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="services.html">Plan de Entrenamiento</a>
