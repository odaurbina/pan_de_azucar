                        ...
                        <div class="col-md-12"> 
                          <div class="form-group">
                              <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="customFileLang">Imagen de la publicidad</label>  
                               </div>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nom_carrera" name="nom_carrera" placeholder="Bici Rock Carrizal" required>
                              </div>
